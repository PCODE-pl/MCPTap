...
EOF
    ...
    for file in 302ai.env abacus.env abliteration-ai.env above.env agentrouter.env agnes.env ai-router.env aiand.env aihubmix.env ainetcafe.env aixy.env aki-io.env alibaba-cn.env alibaba-coding-plan-cn.env alibaba-coding-plan.env alibaba-token-plan-cn.env alibaba-token-plan.env alibaba.env amazon-bedrock.env ambient.env amd.env anthropic.env anyapi.env arcee.env atomic-chat.env auriko.env azure-cognitive-services.env azure.env bailing.env baseten.env berget.env blueclaw.env bothub.env cerebras.env chutes.env clarifai.env claudinio.env cline-pass.env cloudferro-sherlock.env cloudflare-ai-gateway.env cloudflare-workers-ai.env cohere.env coralbricks.env cortecs.env crof.env crossmodel.env crusoe.env daoxe.env databricks.env deepinfra.env deepseek.env digitalocean.env dinference.env drun.env ebcloud.env echo.env edenai.env empiriolabs.env evroc.env fastrouter.env fireworks-ai.env freemodel.env friendli.env frogbot.env github-copilot.env gmicloud.env google-vertex-anthropic.env google-vertex.env google.env greenpt.env groq.env helicone.env hetzner.env hpc-ai.env huggingface.env hyper.env iflowcn.env impossibl.env inception.env inceptron.env inco.env infer.env inference.env inferx.env infomaniak.env io-net.env iteracompute.env jalapeno.env jiekou.env kenari.env kilo.env klokintegration.env kosmik.env kuae-cloud-coding-plan.env lilac.env llama.env llmgateway-providers.env llmgateway.env llmtech.env llmtr.env lmstudio.env longcat.env lucidquery.env lynkr.env mcp-intercept.yaml meganova.env melious.env merge-gateway.env meta.env minimax-cn-coding-plan.env minimax-cn.env minimax-coding-plan.env minimax.env mistral.env mixlayer.env moark.env modal.env model-oracle-ai.env modelis.env modelscope.env moonshotai-cn.env moonshotai.env morph.env nan.env nano-gpt.env nearai.env nebius.env neon.env neosmith.env neuralwatt.env nova.env novita-ai.env nvidia.env oci.env ofox.env ollama-cloud.env openai.env opencode-go.env opencode.env openreason.env openrouter.env opper.env orcarouter.env ovhcloud.env pendra.env per-model.yaml perplexity-agent.env perplexity.env pioneer.env poe.env poolside.env privatemode-ai.env proxy.env qihang-ai.env qiniu-ai.env qvac.env regolo-ai.env requesty.env routing-run.env runinfra.env sakana.env salad-cloud.env sap-ai-core.env sarvam.env scaleway.env scnet-token-plan.env scx-ai.env sensenova.env siliconflow-cn.env siliconflow.env snowflake-cortex.env stackit.env standardcompute.env stepfun-ai.env stepfun-step-plan.env stepfun.env subconscious.env submodel.env synthetic.env tempr.env tencent-coding-plan.env tencent-token-plan.env tencent-tokenhub.env tensorx.env the-grid-ai.env thinkingmachines.env tinfoil.env togetherai.env tokengo.env tokenrouter.env trustedrouter.env umans-ai-coding-plan.env umans-ai.env unorouter.env upstage.env use_tool_hook.py v0.env vancine.env venice.env vercel.env vispark.env vivgrid.env volcengine-coding-plan.env volcengine.env vultr.env wafer.ai.env wallaby.env wandb.env watsonx.env xai.env xiaomi-token-plan-ams.env xiaomi-token-plan-cn.env xiaomi-token-plan-sgp.env xiaomi.env xpersona.env zai-coding-plan.env zai.env zeldoc.env zenifra.env zenmux.env zhipuai-coding-plan.env zhipuai.env; do
