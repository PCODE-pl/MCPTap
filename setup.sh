...
EOF
    ...
    for file in proxy.env openrouter.env requesty.env meta.env nano-gpt.env llmtr.env kenari.env unorouter.env runinfra.env nvidia.env opencode.env mcp-intercept.yaml per-model.yaml use_tool_hook.py; do
